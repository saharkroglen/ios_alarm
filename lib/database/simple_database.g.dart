...
abstract class _$SimpleAppDatabase extends GeneratedDatabase {
  _$SimpleAppDatabase(QueryExecutor e) : super(e);
  $SimpleAppDatabaseManager get managers => $SimpleAppDatabaseManager(this);
...
class $$RemindersTableFilterComposer
    extends Composer<_$SimpleAppDatabase, $RemindersTable> {
...
class $$RemindersTableTableManager
    extends
        ...
        > {
  $$RemindersTableTableManager(_$SimpleAppDatabase db, $RemindersTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$RemindersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        model.Reminder,
        BaseReferences<_$SimpleAppDatabase, $RemindersTable, model.Reminder>,
      ),
      model.Reminder,
      PrefetchHooks Function()
    >;
...
class $$PendingNotificationsTableFilterComposer
    extends Composer<_$SimpleAppDatabase, $PendingNotificationsTable> {
...
class $SimpleAppDatabaseManager {
  final _$SimpleAppDatabase _db;
  $SimpleAppDatabaseManager(this._db);
